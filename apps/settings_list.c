...
#endif
    OFFON_SETTING(F_THEMESETTING, show_album_art, LANG_SHOW_ALBUM_ART, true,
                  "show album art", NULL),
    TABLE_SETTING(F_ALLOW_ARBITRARY_VALS, thumb_art_size, LANG_THUMB_ART_SIZE,
                  -1, "album art size", "auto", UNIT_PIXEL,
                  list_pad_formatter, list_pad_getlang, NULL, 12,
                  -1,16,20,24,28,32,36,40,44,64,96,128),
    INT_SETTING(F_THEMESETTING, thumb_theme_size, LANG_THUMB_ART_SIZE,
                0, "album art theme size", UNIT_PIXEL, 0, 128, 1, NULL, NULL, NULL),
    INT_SETTING(F_THEMESETTING, thumb_art_padding, LANG_THUMB_ART_PADDING,
                0, "album art padding", UNIT_PIXEL, 0, 6, 1, NULL, NULL, NULL),
    TEXT_SETTING(F_THEMESETTING, thumb_fallback_file, "album art fallback",
                 "", NULL, NULL),
    TABLE_SETTING(0, list_corner_radius, LANG_LIST_CORNER_RADIUS,
                  0, "list corner radius", "off,2,4,6,8,10,12", UNIT_PIXEL,
                  list_pad_formatter, list_pad_getlang, NULL, 7,
                  0,2,4,6,8,10,12),
#endif
