...
/* 3-d enhancement effect */
    ...
    OFFON_SETTING(F_THEMESETTING, show_album_art, LANG_SHOW_ALBUM_ART, true,
                  "show album art", NULL),
    TABLE_SETTING(F_ALLOW_ARBITRARY_VALS, thumb_row_height, LANG_THUMB_ROW_HEIGHT,
                  -1, "album art row height", "auto", UNIT_PIXEL,
                  list_pad_formatter, list_pad_getlang, NULL, 9,
